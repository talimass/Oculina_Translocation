...
source /lustre1/home/mass/eskalon/miniconda/bin/activate eggnog
#########################################
...
emapper.py -i  protein.faa \
  --itype proteins --data_dir /lustre1/home/mass/eskalon/eggnog/db \
  -m diamond --dbmem --output Ocpat_eggnog \
